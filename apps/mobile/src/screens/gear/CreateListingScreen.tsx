    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.quickFillRow}>
          ...
          >
            {lookupBusy ? <ActivityIndicator color="#D0216A" /> : (
              <>
          ...
          >
            {visionBusy ? <ActivityIndicator color="#D0216A" /> : (
              <>
                <Text style={styles.quickFillIcon}>✨</Text>
...
const styles = StyleSheet.create({
  ...
  back: { fontSize: 14, color: '#D0216A', fontFamily: FONTS.bodySemiBold, minWidth: 50 },
  ...
  prohibitedLink: { color: '#D0216A', fontFamily: FONTS.bodySemiBold, textDecorationLine: 'underline' },
  ...
  chipActive: { backgroundColor: '#D0216A', borderColor: '#D0216A' },  // v9 CTA = cinnamon
  ...
  priceHintCta: {
    fontFamily: FONTS.bodySemiBold, color: '#D0216A',
  },
  ...
  uploadFill: {
    height: '100%',
    backgroundColor: '#D0216A',                                        // v9 progress = cinnamon
  },
});
