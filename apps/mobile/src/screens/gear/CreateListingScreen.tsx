    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.quickFillRow}>
          ...
          >
            {lookupBusy ? <ActivityIndicator color="#E02F5F" /> : (
              <>
          ...
          >
            {visionBusy ? <ActivityIndicator color="#E02F5F" /> : (
              <>
                <Text style={styles.quickFillIcon}>✨</Text>
...
const styles = StyleSheet.create({
  ...
  back: { fontSize: 14, color: '#E02F5F', fontFamily: FONTS.bodySemiBold, minWidth: 50 },
  ...
  prohibitedLink: { color: '#E02F5F', fontFamily: FONTS.bodySemiBold, textDecorationLine: 'underline' },
  ...
  chipActive: { backgroundColor: '#E02F5F', borderColor: '#E02F5F' },  // v9 CTA = cinnamon
  ...
  priceHintCta: {
    fontFamily: FONTS.bodySemiBold, color: '#E02F5F',
  },
  ...
  uploadFill: {
    height: '100%',
    backgroundColor: '#E02F5F',                                        // v9 progress = cinnamon
  },
});
