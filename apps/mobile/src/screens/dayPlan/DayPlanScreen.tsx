...
const PLAN_PROMPTS: PlanPrompt[] = [
  {
    ...
    tile: ['#FBD9E1', '#F7C0CE'], arrow: '#D0216A', border: '#F4DBDF',
  },
  {
...
const KIND_STYLE: Record<PlanSlot['kind'], { bg: string; border: string; mark?: string; markColor?: string }> = {
  ...
  nap: { bg: '#FDECEF', border: '#F3C6D2', mark: '✦ VILLIE', markColor: '#6E1A47' },
  feed: { bg: '#FDECEF', border: '#F3C6D2', mark: '✦ VILLIE', markColor: '#6E1A47' },
