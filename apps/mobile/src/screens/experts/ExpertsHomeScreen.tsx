...
const dc = StyleSheet.create({
  ...
  licVerify: { color: '#8A1F3E', fontFamily: FONTS.v2_bold },
...
const styles = StyleSheet.create({
  ...
  backToVillageText: { fontSize: 14, color: '#E02F5F', fontFamily: FONTS.bodySemiBold },
  ...
  careSearchIcon: { fontSize: 18, color: '#8A1F3E' },
  ...
  tierSegActive: { backgroundColor: '#E02F5F' },
  ...
  chipTextActive: { color: '#E02F5F', textDecorationLine: 'underline' },
