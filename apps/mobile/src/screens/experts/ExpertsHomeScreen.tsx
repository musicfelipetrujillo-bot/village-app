...
const dc = StyleSheet.create({
  ...
  licVerify: { color: '#B03A22', fontFamily: FONTS.v2_bold },
...
const styles = StyleSheet.create({
  ...
  backToVillageText: { fontSize: 14, color: '#E14A32', fontFamily: FONTS.bodySemiBold },
  ...
  careSearchIcon: { fontSize: 18, color: '#B03A22' },
  ...
  tierSegActive: { backgroundColor: '#E14A32' },
  ...
  chipTextActive: { color: '#E14A32', textDecorationLine: 'underline' },
