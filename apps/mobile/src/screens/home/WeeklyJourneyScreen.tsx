...
const styles = StyleSheet.create({
  ...
  headerBack: { fontSize: 15, color: '#D0216A', fontFamily: FONTS.bodySemiBold },
  ...
  crisisFooterText: { fontSize: 13, color: '#D0216A', fontFamily: FONTS.bodySemiBold, lineHeight: 18 },
  ...
  todoTileEssential: {
    borderColor: '#D0216A', borderWidth: 1.5,                                    // active essential = cinnamon
  },
  todoTileDone: {
  ...
  checkboxChecked: { backgroundColor: '#D0216A', borderColor: '#D0216A' },
  ...
  crisisLinkText: { fontSize: 13, color: '#D0216A', fontFamily: FONTS.bodySemiBold },
});
