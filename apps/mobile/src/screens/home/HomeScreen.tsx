...
const MANUAL_PILL_COLORS: Record<ManualPillTone, { bg: string; fg: string }> = {
  ...
  tips:    { bg: '#B03A22', fg: '#FFFCF6' }, // marigold — cocoa fg
};
...
const styles = StyleSheet.create({
  ...
  greetingNameAccent: {
    ...
    color: '#E14A32',  // v9 italic flourish — cinnamon per brand kit
  },
  ...
  welcomeTopBar: {
    ...
    height: 2,
    backgroundColor: '#E14A32',    // action-deep
  },
  welcomeRowTop: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Action pill — uses action-deep #E14A32 instead of the lighter muted
  ...
  checkinCta: { fontSize: 13, fontFamily: FONTS.bodySemiBold, color: '#E14A32', marginTop: 10 },
  ...
  twinHalfCta: {
    ...
    color: '#E14A32', letterSpacing: 0.3,
    marginTop: 'auto',
  },
  ...
  weekHeroTopBar: {
    ...
    height: 2,
    backgroundColor: '#7A4A24',    // rust-deep — matches weekHeroEyebrow color (was #E14A32)
    zIndex: 3,
  },
  weekHeroYolk: {
    position: 'absolute',
  ...
  weekHeroCtaText: {
    fontFamily: FONTS.bodyBold,
    fontSize: 11.5,
    color: '#E14A32', // action-deep (muted clay)
    letterSpacing: 0.4,
    fontWeight: '700',
  },
  weekHeroArrow: {
    // Bumped from #E98A6A (3.77:1 paper) to #E14A32 action-deep (4.85:1
  ...
  checkinStripArrow: {
    // Same WCAG fix as Week arrow — #E14A32 action-deep gives 4.85:1
  ...
  manualBlockLink: {
    fontFamily: FONTS.bodySemiBold,
    fontSize: 11,
    color: '#E14A32',  // v9 cinnamon — link per brand kit
  },
  ...
  feedHeaderLink: {
    fontSize: 12, color: '#E14A32', fontFamily: FONTS.bodySemiBold,
  },
  eventRow: {
