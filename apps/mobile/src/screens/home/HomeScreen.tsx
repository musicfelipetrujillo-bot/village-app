...
const MANUAL_PILL_COLORS: Record<ManualPillTone, { bg: string; fg: string }> = {
  ...
  tips:    { bg: '#8A1F3E', fg: '#FFFCF6' }, // marigold — cocoa fg
};
...
const styles = StyleSheet.create({
  ...
  greetingNameAccent: {
    ...
    color: '#E02F5F',  // v9 italic flourish — cinnamon per brand kit
  },
  ...
  welcomeTopBar: {
    ...
    height: 2,
    backgroundColor: '#E02F5F',    // action-deep
  },
  welcomeRowTop: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Action pill — uses action-deep #E02F5F instead of the lighter muted
  ...
  checkinCta: { fontSize: 13, fontFamily: FONTS.bodySemiBold, color: '#E02F5F', marginTop: 10 },
  ...
  emptyCta: {
    backgroundColor: '#E02F5F', borderRadius: 999,
  ...
  twinHalfCta: {
    ...
    color: '#E02F5F', letterSpacing: 0.3,
    marginTop: 'auto',
  },
  ...
  weekHeroTopBar: {
    ...
    height: 2,
    backgroundColor: '#7A4A24',    // rust-deep — matches weekHeroEyebrow color (was #E02F5F)
    zIndex: 3,
  },
  weekHeroYolk: {
    position: 'absolute',
  ...
  weekHeroCtaText: {
    fontFamily: FONTS.bodyBold,
    fontSize: 11.5,
    color: '#E02F5F', // action-deep (muted clay)
    letterSpacing: 0.4,
    fontWeight: '700',
  },
  weekHeroArrow: {
    // Bumped from #E98A6A (3.77:1 paper) to #E02F5F action-deep (4.85:1
  ...
  checkinStripArrow: {
    // Same WCAG fix as Week arrow — #E02F5F action-deep gives 4.85:1
  ...
  manualBlockLink: {
    fontFamily: FONTS.bodySemiBold,
    fontSize: 11,
    color: '#E02F5F',  // v9 cinnamon — link per brand kit
  },
  ...
  feedHeaderLink: {
    fontSize: 12, color: '#E02F5F', fontFamily: FONTS.bodySemiBold,
  },
  eventRow: {
