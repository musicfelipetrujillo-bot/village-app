    ...
    <View style={[styles.container, kbHeight > 0 && { paddingBottom: kbHeight }]}>
      ...
      {sending && (
        <View style={styles.typingRow}>
          <ActivityIndicator color="#D0216A" size="small" />
...
const styles = StyleSheet.create({
  ...
  headerClose: { fontSize: 32, color: '#6E1A47', marginTop: -6, fontFamily: FONTS.body },
  ...
  bubbleMine: { backgroundColor: '#D0216A', borderBottomRightRadius: 4 },
  ...
  qrText: { fontSize: 14, color: '#6E1A47', fontFamily: FONTS.bodySemiBold, letterSpacing: 0.1 },
  ...
  ctaPill: {
    backgroundColor: '#6E1A47', borderRadius: 18, paddingHorizontal: 16, paddingVertical: 10,
  ...
  suggestArrow: { fontSize: 17, color: '#D0216A', fontFamily: FONTS.bodySemiBold, marginTop: -1 },
  ...
  sendBtn: {
    ...
    backgroundColor: '#D0216A', alignItems: 'center', justifyContent: 'center',
  },
