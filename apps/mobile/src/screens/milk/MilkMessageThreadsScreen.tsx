...
const styles = StyleSheet.create({
  ...
  back: { fontSize: 15, color: '#C24A63', fontFamily: FONTS.bodyMedium },
  ...
  avatarInitial: { color: '#FFFCF6', fontSize: 18, fontFamily: FONTS.bodySemiBold },
  middle: { flex: 1 },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  name: { fontSize: 15, fontFamily: FONTS.bodySemiBold, color: '#43260F', flexShrink: 1 },
  donorTag: {
    fontSize: 10, fontFamily: FONTS.bodySemiBold, color: '#FFFCF6',
    backgroundColor: '#E98A6A', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6,
  },
  preview: { fontSize: 13, color: '#7A4A24', marginTop: 4 },
  rightCol: { alignItems: 'flex-end', gap: 6 },
  time: { fontSize: 11, color: '#7A4A24' },
  unreadDot: {
  ...
  browseBtn: {
    marginTop: 8, backgroundColor: '#E14A32', borderRadius: 12,
