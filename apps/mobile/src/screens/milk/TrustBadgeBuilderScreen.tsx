...
export default function TrustBadgeBuilderScreen({ route, navigation }: Props) {
  ...
  if (loading) {
    return <View style={styles.center}><ActivityIndicator color="#D0216A" /></View>;
  }
...
const styles = StyleSheet.create({
  ...
  backChevron: { fontSize: 30, color: '#6E1A47', marginTop: -2 },
  ...
  flagChipActive: { borderColor: '#D0216A', backgroundColor: 'rgba(192,120,64,0.08)' },
  ...
  continueBtn: {
    backgroundColor: '#D0216A', borderRadius: 14, paddingVertical: 16, alignItems: 'center',
  ...
  modalAdd: { flex: 1, backgroundColor: '#D0216A', borderRadius: 10, paddingVertical: 12, alignItems: 'center' },
