...
export default function TrustBadgeBuilderScreen({ route, navigation }: Props) {
  ...
  if (loading) {
    return <View style={styles.center}><ActivityIndicator color="#E02F5F" /></View>;
  }
...
const styles = StyleSheet.create({
  ...
  backChevron: { fontSize: 30, color: '#8A1F3E', marginTop: -2 },
  ...
  flagChipActive: { borderColor: '#E02F5F', backgroundColor: 'rgba(192,120,64,0.08)' },
  ...
  continueBtn: {
    backgroundColor: '#E02F5F', borderRadius: 14, paddingVertical: 16, alignItems: 'center',
  ...
  modalAdd: { flex: 1, backgroundColor: '#E02F5F', borderRadius: 10, paddingVertical: 12, alignItems: 'center' },
