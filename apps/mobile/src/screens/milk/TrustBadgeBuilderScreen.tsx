...
const styles = StyleSheet.create({
  ...
  continueBtn: {
    backgroundColor: '#E14A32', borderRadius: 14, paddingVertical: 16, alignItems: 'center',
  ...
  modalAdd: { flex: 1, backgroundColor: '#E14A32', borderRadius: 10, paddingVertical: 12, alignItems: 'center' },
