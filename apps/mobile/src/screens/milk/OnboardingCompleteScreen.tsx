...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 30, fontFamily: FONTS.headerBold, color: '#2C1810', marginBottom: 12, textAlign: 'center', letterSpacing: -0.5, lineHeight: 36 },
  ...
  doneBtn: {
    backgroundColor: '#C07840', borderRadius: 14, paddingVertical: 16, paddingHorizontal: 40,
    shadowColor: '#945A41', shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.24, shadowRadius: 10, elevation: 3,
  },
  doneBtnText: { fontSize: 16, fontFamily: FONTS.bodySemiBold, color: '#FDFBF6' },
});
