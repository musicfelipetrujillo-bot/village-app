  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <BackButton color="#C24A63" style={styles.backBtn} accessibilityLabel={t('donorSearch.back')} />
...
const styles = StyleSheet.create({
  ...
  emptyReset: { fontSize: 14, color: '#C24A63', fontFamily: FONTS.bodySemiBold, marginTop: 8 },
});
