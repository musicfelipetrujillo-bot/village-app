...
const styles = StyleSheet.create({
  ...
  optionActive: { borderColor: '#D96C88', backgroundColor: 'rgba(192,120,64,0.06)', shadowOpacity: 0.22 },
  radio: {
  ...
  radioActive: { borderColor: '#D96C88' },
  radioDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#D96C88' },
