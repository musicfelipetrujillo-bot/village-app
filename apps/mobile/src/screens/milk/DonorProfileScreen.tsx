  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        <BackButton color="#C24A63" style={styles.backBtnAbsolute} accessibilityLabel={t('donorProfile.back')} />
  ...
  if (!profile) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <BackButton color="#C24A63" accessibilityLabel={t('donorProfile.goBack')} />
      </View>
    );
  }
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.hero}>
          <BackButton color="#C24A63" style={styles.backBtn} accessibilityLabel={t('donorProfile.back')} />
      ...
      <Modal visible={qaModalVisible} animationType="slide" transparent>
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            {qaLoading && <ActivityIndicator color="#C24A63" style={{ marginVertical: 12 }} />}
...
const styles = StyleSheet.create({
  ...
  backLink: { fontSize: 15, color: '#C24A63', fontFamily: FONTS.bodySemiBold },
  ...
  messageBtnText: { fontSize: 15, color: '#C24A63', fontFamily: FONTS.bodySemiBold },
