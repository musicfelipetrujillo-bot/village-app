...
export default function RsvpConfirmScreen() {
  ...
  if (!event) {
    return <View style={styles.container}><ActivityIndicator color="#D0216A" style={{ marginTop: 80 }} /></View>;
  }
...
const styles = StyleSheet.create({
  ...
  doneBtnText: { color: '#D0216A', fontSize: 14, fontFamily: FONTS.bodySemiBold },
