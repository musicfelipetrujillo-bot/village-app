...
export default function RsvpConfirmScreen() {
  ...
  if (!event) {
    return <View style={styles.container}><ActivityIndicator color="#E02F5F" style={{ marginTop: 80 }} /></View>;
  }
...
const styles = StyleSheet.create({
  ...
  doneBtnText: { color: '#E02F5F', fontSize: 14, fontFamily: FONTS.bodySemiBold },
