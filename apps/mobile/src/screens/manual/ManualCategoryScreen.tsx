...
// rust since those resolve to brand-v2 cinnamon (#D0216A), which is a
// different shade than the v9 mockup's --coco (#AD795B) / --rust
// (#D0216A). The screen is meant to look exactly like the mockup.
// ═══════════════════════════════════════════════════════════════════════
const V9 = {
  paper: '#FFFCF6',
  bgPink: '#FAEDE3',
  ...
  rust: '#D0216A',     // cinnamon (was #D0216A)
  rustDeep: '#D0216A', // action-deep (was #7A4A24)
  sage: '#E98A6A',
  sageDeep: '#E98A6A',
  coco: '#AD795B',
  cocoDeep: '#E98A6A',
...
export const CHAPTER_THEME: Record<string, ChapterTheme> = {
  // Grow / Feel — rose
  'baby/grow':  { accent: '#D0216A', accentDeep: '#D0216A', bg: '#FAE2E7', yolkBg: '#FAE2E7' },
  'mom/feel':   { accent: '#D0216A', accentDeep: '#D0216A', bg: '#FAE2E7', yolkBg: '#FAE2E7' },
...
const styles = StyleSheet.create({
  ...
  clipProPill: {
    position: 'absolute', top: 3, left: 3, backgroundColor: '#D0216A',
