  ...
  return (
    <TouchableOpacity
      ...
      accessibilityLabel={locked
        ...
        : data.title}
    >
      <LinearGradient colors={['#F0B68C', '#E98A6A', '#E02F5F']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.wiHero}>
        ...
        <View style={styles.wiPlay}>
          {locked ? (
            <Svg width={20} height={20} viewBox="0 0 24 24">
              <Path d="M12 2a5 5 0 0 0-5 5v3H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-1V7a5 5 0 0 0-5-5zm-3 8V7a3 3 0 1 1 6 0v3H9z" fill="#8A1F3E" />
            </Svg>
          ) : (
            <Svg width={20} height={20} viewBox="0 0 24 24"><Path d="M8 5l11 7-11 7z" fill="#8A1F3E" /></Svg>
          )}
        </View>
...
export default function ManualScrollV3() {
  ...
  const chapterAccent = CHIP_TONE[chapter.cat]?.bg ?? '#E02F5F';
        ...
        {expecting && (
          <View style={{ paddingHorizontal: 20, marginBottom: 4 }}>
            <TouchableOpacity onPress={goToBeforeBaby} activeOpacity={0.9} accessibilityRole="button"
              ...
              <LinearGradient colors={['#E02F5F', '#F2C75E']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.bbCard}>
...
const styles = StyleSheet.create({
  ...
  wiBadgePro: { position: 'absolute', top: 9, left: 11, backgroundColor: '#E02F5F', borderRadius: 999, paddingHorizontal: 9, paddingVertical: 3 },
  wiBadgeText: { fontFamily: FONTS.v2_mono, fontSize: 8.5, letterSpacing: 1.6, color: '#FFF1DC', fontWeight: '700' },
  wiLockedCta: { fontFamily: FONTS.bodyBold, fontSize: 12, color: '#E02F5F', marginTop: 6 },
