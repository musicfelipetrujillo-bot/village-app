...
const FAMILY_MARIGOLD: ChapterFamily = { bg: '#F7C5CB', accent: '#6E1A47' };
...
const styles = StyleSheet.create({
  ...
  titleItalic: {
    ...
    color: '#D0216A',  // v9 rust-deep — one italic flourish in the brand spark color
  },
  subtitle: {
  ...
  savedLinkIcon: { fontSize: 12, color: '#D0216A' },
  savedLinkText: {
