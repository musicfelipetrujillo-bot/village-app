...
const FAMILY_MARIGOLD: ChapterFamily = { bg: '#F7C5CB', accent: '#8A1F3E' };
...
const styles = StyleSheet.create({
  ...
  titleItalic: {
    ...
    color: '#E02F5F',  // v9 rust-deep — one italic flourish in the brand spark color
  },
  subtitle: {
  ...
  savedLinkIcon: { fontSize: 12, color: '#E02F5F' },
  savedLinkText: {
