  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#D0216A" />}
      >
        ...
        <View style={styles.toggleCard}>
          ...
          <Switch
            ...
            disabled={saving}
            trackColor={{ false: '#D1C5AC', true: '#D0216A' }}
        ...
        {identitiesLoading ? (
          <View style={styles.centerSmall}><ActivityIndicator color="#D0216A" /></View>
        ) : identities.length > 0 ? (
          <>
...
const styles = StyleSheet.create({
  ...
  previewAlias: {
    fontSize: 24, fontFamily: FONTS.headerBold, color: '#D0216A',
    marginBottom: 4,
  },
  previewHint: {
  ...
  regenerateBtn: {
    ...
    borderRadius: 999,
    borderWidth: 1.5, borderColor: '#D0216A',
  },
  regenerateText: { fontSize: 12, fontFamily: FONTS.bodySemiBold, color: '#D0216A' },
  ...
  identityAlias: { fontSize: 14, fontFamily: FONTS.bodySemiBold, color: '#D0216A' },
