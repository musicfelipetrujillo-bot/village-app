  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 100 100"
      ...
      <Ellipse cx="36" cy="33" rx="17" ry="11" fill="#FFFFFF" fillOpacity={0.6}
        stroke="#DA9A2C" strokeOpacity={0.45} strokeWidth={1}
        transform="rotate(-26 36 33)" />
      <Ellipse cx="55" cy="31" rx="13" ry="9" fill="#FFFFFF" fillOpacity={0.5}
        stroke="#DA9A2C" strokeOpacity={0.4} strokeWidth={1}
...
export function CoffeeCup({ size = 26 }: { size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 28 28">
      {/* steam */}
      <Path d="M10 7 q2.4 -2.2 0 -4.4" stroke="#E02F5F" strokeWidth={1.3} fill="none" strokeLinecap="round" opacity={0.55} />
      <Path d="M15 7 q2.4 -2.2 0 -4.4" stroke="#E02F5F" strokeWidth={1.3} fill="none" strokeLinecap="round" opacity={0.45} />
      {/* handle */}
