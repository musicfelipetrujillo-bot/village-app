...
export function CoffeeCup({ size = 26 }: { size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 28 28">
      {/* steam */}
      <Path d="M10 7 q2.4 -2.2 0 -4.4" stroke="#D0216A" strokeWidth={1.3} fill="none" strokeLinecap="round" opacity={0.55} />
      <Path d="M15 7 q2.4 -2.2 0 -4.4" stroke="#D0216A" strokeWidth={1.3} fill="none" strokeLinecap="round" opacity={0.45} />
      {/* handle */}
