...
export const ROW_META: Record<SheetRowKind, RowMeta> = {
  ...
  bottle: { emoji: '🍼', label: 'Bottle', chip: '#FBD9E1', rowBg: '#FDEFF2', timeColor: '#B03A22', textColor: '#3D2116' },
  nap:    { emoji: '💤', label: 'Nap',    chip: '#F6E2AE', rowBg: '#FCF3DC', timeColor: '#B98A1E', textColor: '#3D2116' },
  meal:   { emoji: '🍽️', label: 'Meal',   chip: '#FBD9E1', rowBg: '#FDEFF2', timeColor: '#B03A22', textColor: '#3D2116' },
