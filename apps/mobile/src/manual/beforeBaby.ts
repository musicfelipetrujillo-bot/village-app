...
export function beforeBabyHtml(checked: Set<string>, babyName?: string): string {
  ...
  <style>
    ...
    h2{font-size:15px;letter-spacing:.14em;text-transform:uppercase;color:#6E1A47;margin:22px 0 8px;border-bottom:1px solid #EFE0C8;padding-bottom:6px;}
    ...
    .bx{width:16px;height:16px;border:1.5px solid #6E1A47;border-radius:4px;flex:0 0 auto;text-align:center;line-height:15px;color:#fff;font-size:11px;}
    .bx.on{background:#6E1A47;}
