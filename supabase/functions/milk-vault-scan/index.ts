...
Deno.serve(async (req) => {
  ...
  // gateway. This function runs Haiku over a supplied milk-vault image, so anyone who extracted that key had a free,
  ...
  // mid-flow.
  const quota = await consumeQuota(callerId, 'milk-vault-scan');
