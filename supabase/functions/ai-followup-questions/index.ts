...
Deno.serve(async (req) => {
  ...
  // gateway. This function generates follow-up questions via Haiku, so anyone who extracted that key had a free,
  ...
  // mid-flow.
  const quota = await consumeQuota(callerId, 'ai-followup-questions');
