-- 099_v6_milk_vault.sql
-- =====================================================================
-- V6 · Milk Vault — personal freezer-stash tracker + optional
-- sell/donate marketplace-planning layer.
--
-- Numbered 099 (originally drafted as 098) so it doesn't collide with
-- 098_retire_milk_stripe_connect.sql, which is queued on its own branch.
--
